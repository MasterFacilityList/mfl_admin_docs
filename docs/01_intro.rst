...
.. figure:: /_images/chrio/01_c_forgot_password.png
    :scale: 100%
...
.. figure:: /_images/chrio/reset_password_email.png
    :scale: 100%
    :alt: The reset password form link

The user should click on the link and will be redirected back to the
administration system where  a screen similar to the one below will be
displayed.

 .. figure:: /_images/chrio/confirm_password_change.png
    :scale: 100%
    :alt: Create a new password
